    ...
    ">
        ...
        <div className="flex flex-wrap w-full py-4 md:py-4 space-y-8 md:space-y-0">
          ...
          <div className="w-full md:w-1/4 px-4 pr-8 border-r-2 border-white border-w-full p-4 m-0">
            <h3 className="text[13px] font-[100] text-gray-800 pb-2 border-b border-gray-400">
              Company
            </h3>
          </div>
          ...
          <div className="w-full  black md:w-2/5 px-4 p-4 m-0">
            <p className="mb-3 h-22 text-[12px]">
