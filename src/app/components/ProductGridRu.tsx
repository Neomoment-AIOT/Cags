...
const products = [
  ...
  {
    title: 'CAGS',
    subtitle: 'Бумага для самокруток',
    link: '/products/productsRu/papers',
    productImg: '/rollingpaper.png',
  },
  {
    title: 'CAGS',
    subtitle: 'Сигаретные гильзы',
    link: '/products/productsRu/tubes',
    productImg: '/cigarettetubes.png',
  },
  {
    title: 'CAGS',
    subtitle: 'Табак',
    link: '/products/productsRu/tobacco',
    productImg: '/tobacco.png',
  },
  {
    title: 'CAGS',
    subtitle: ' Табак для кальянов',
