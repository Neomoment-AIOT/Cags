            ...
            <div className={styles.column}>
              <div className={styles.mainTextContainer}>
                <div className={styles.title}>
                  <h1>
                    Discover<br />
                    <span className={styles.fontLight}>Our certificates</span>
                  </h1>
                </div>
                <div className={styles.lineSeparator}></div>
                <div className={styles.textContent}>
                  <p>
                    Discover our certificates and witness our commitment to excellence. We hold internationally recognized ISO certifications, ensuring superior quality and adherence to industry standards.
                  </p>
                </div>
              </div>
            </div>
