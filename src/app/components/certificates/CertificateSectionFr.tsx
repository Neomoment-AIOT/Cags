            ...
            <div className={styles.column}>
              <div className={styles.mainTextContainer}>
                <div className={styles.title}>
                  <h1>
                    Découvrez<br />
                    <span className={styles.fontLight}>Nos certificats </span>
                  </h1>
                </div>
                <div className={styles.lineSeparator}></div>
                <div className={styles.textContent}>
                  <p>
                    Découvrez nos certificats et constatez notre engagement envers l'excellence. Nous détenons des certifications ISO reconnues internationalement, garantissant une qualité supérieure et le respect des normes de l'industrie.
                  </p>
                </div>
              </div>
            </div>
