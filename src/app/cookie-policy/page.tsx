...
Other Data <br/>
 <br/>Data Category: Identity Information 
 <br/>Description: Data related to the identification of individuals. 
 ...
 <br/>We collect the identity information of our customers to fulfill our legal obligations, provide support services, fulfill commercial requirements and legal obligations, and for advertising and marketing purposes, audit processes, and security purposes.
...
Sometimes, we collect identity information based on our legitimate interests and the principles adopted by our Company.
 ...
 <br/>Data Category: Education Information
 <br/>Description: Information necessary for the smooth provision of services within the scope of contractual relationship.
...
Furthermore, we collect education information based on the contractual relationship between us and the relevant individuals.
 <br/>Data Collection Method: We collect data through printed forms and sometimes directly through company-shared electronic areas and electronic devices.
 <br/>Data Category: Contact Information
 <br/>Description: Personal data that enables communication with individuals.
 <br/>Source: We collect contact information from our job applicants, employees, customers, potential service recipients, platform users, business partners, and visitors.
 <br/>Content: Email address, residence address, mailing address, workplace address, workplace name and title, home phone number, mobile phone number, other phone and fax numbers, etc.
 <br/>Purpose of Data Collection: We collect the contact information of our job applicants for the purpose of conducting human resources activities related to the applied position.
 <br/>We collect the contact information of our employees in accordance with our obligations arising from employment, social security, tax regulations, etc.
 <br/>We collect the contact information of our customers to fulfill our legal obligations, provide support services, fulfill commercial requirements and legal obligations, and for advertising and marketing purposes, audit processes, and security purposes.
 <br/>We collect the contact information of our platform users to fulfill our legal obligations.
 <br/>We collect the contact information of our visitors for the purpose of ensuring security during building entry and exit and for future service relationships.
 <br/>We collect the contact information of our business partners to fulfill our legal obligations, provide support services, issue invoices, carry out audit processes, monitor joint projects, and fulfill our obligations under contracts.
 <br/>Legal Basis for Data Collection: The primary reason for collecting this data is compliance with relevant legislation.
...
Sometimes, we collect contact information based on our legitimate interests and the principles adopted by our Company.
 <br/>Data Collection Method: We collect data through printed forms and sometimes directly through company-shared electronic areas and electronic devices.
 <br/>Data Category: Financial Information
 <br/>Description: Data such as bank account information, credit card information, invoice information, etc. Source: We collect financial information from our employees and customers.
 <br/>Content: Bank account information, bank card information, credit card information, signature circulars, income information, asset information, payroll information, minimum income deduction information, information about disability tax liability, records related to salary garnishment, etc.
 <br/>Purpose of Data Collection: We collect the financial information of our employees to fulfill our obligations arising from employment, social security, tax regulations, etc.
 <br/>We collect the financial information of our customers to fulfill our legal obligations, provide support services, fulfill commercial requirements and legal obligations, and for advertising and marketing purposes, audit processes, and security purposes.
 <br/>
Legal Basis for Data Collection: The main reason for collecting the data is the obligations stated in the relevant legislation.
 <br/>Additionally, we collect financial information due to the contractual relationship we have with the individuals.
At times, we also collect financial information for purposes such as including our employees in campaigns or promotions provided by banks or other financial institutions we collaborate with, based on our legitimate interests and Company principles.
 <br/>Data Collection Method: We collect the data through printed forms and sometimes directly through company internal shared spaces and electronic devices.
 <br/>Data Category: Personal Data
 <br/>Description: These are the necessary information for the smooth continuation of the employment relationship.
 <br/>Collected From: We collect employee data from job applicants and employees.
 ...
 <br/>Purpose of Data Collection: We collect communication information of job applicants in order to carry out human resources activities related to the applied position.
...
Legal Basis for Data Collection: The main reason for collecting these data is the obligations stated in the relevant legislation.
 <br/>Additionally, we collect personal information due to the contractual relationship we have with the individuals
...
Data Collection Method: We collect the data through printed forms and sometimes directly through company internal shared spaces and electronic devices.
 <br/>Data Category: Other Data
 <br/>Description: These are other data collected within the scope of our company activities. Collected From: We collect this data from our visitors.
 <br/>Content: Visited person, purpose of the visit, date and time of the visit, and similar data. Purpose of Data Collection: Information related to visitors' visits is collected in order to identify potential service recipients.
 <br/>
Additionally, we collect this data for security reasons.
 <br/>Legal Basis for Data Collection: The main reason for collecting these data is the obligations stated in the relevant legislation.
At times, we collect these data based on our legitimate interests and Company principles, for example, to improve the quality of the provided service or for security purposes.
 <br/>Data Collection Method: We collect the data through printed forms and sometimes directly through company internal shared spaces and electronic devices.
 <br/>Do We Transfer Your Personal Data to Third Parties?
 <br/>Due to legal regulations in our country, identity information, contact information, and many other personal data mentioned above are shared with authorized entities explicitly stated in the legislation periodically or upon the requests of authorized authorities.
 ...
 <br/>Do We Transfer Your Personal Data Abroad?
 <br/>Your personal data can be transferred abroad only if one of the following conditions is met: With your explicit consent,
 ...
 <br/>How Long Are Your Personal Data Retained?
 <br/>The retention periods of your personal data are as follows:
