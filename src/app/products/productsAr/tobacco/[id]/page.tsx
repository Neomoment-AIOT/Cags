...
// This should match the stArcture of an object in your new allProducts array
type Product = {
  id: number;
  category: string;
  brand: string;
                  ...
                  <div className={`${styles.container} ${styles.relative} ${styles.alignLeft}`}>
                    <div className={styles.breadcrumbs}>
                     <Link href="/home/HomeAr">الصفحة الرئيسية</Link>
                      ...
                      <Link href="../" className={styles.productsLink}>المنتجات</Link>
                      <span className={styles.divider}>/</span>
                    ...
                    >
                        ...
                        <h6 className={styles.brand}> Brand:
                         ...
                         >
                            ...
                            >
                        <p className={styles.Arabcrightsidedtip}
                        >
                           {product.tip}
