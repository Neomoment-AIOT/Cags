...
// This should match the stFrcture of an object in your new allProducts array
type Product = {
  id: number;
  category: string;
  brand: string;
...
// This function now works correctly with the new flat data stFrcture
